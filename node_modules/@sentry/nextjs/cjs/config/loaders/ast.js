...
var jscsTypes = require('jscodeshift');
...
var jscs = jscsTypes.default || jscodeshiftNamespace;
...
function makeAST(code) {
  ...
  return jscs(code, { parser: parser.parser });
}
...
exports.getExportIdentifierNames = getExportIdentifierNames;
